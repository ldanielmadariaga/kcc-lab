...
// WriteField replaces a field it cannot type with a "// TODO:" comment and
// moves on, so the field never reaches the CRD. The 239-resource run had 15
// such markers in scaffolded type files and 37 in types.generated.go, which
// together cost 124 CRD field paths that nothing else recorded.

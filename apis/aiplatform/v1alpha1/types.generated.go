...
type ExplanationMetadata struct {
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1.ExplanationMetadata.inputs
	// +required
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1.ExplanationMetadata.outputs
	// +required
...
type PipelineJob_RuntimeConfig struct {
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1.PipelineJob.RuntimeConfig.parameters
	...
	//  DSL.
	// +kcc:proto:field=google.cloud.aiplatform.v1.PipelineJob.RuntimeConfig.parameter_values
	ParameterValues map[string]apiextensionsv1.JSON `json:"parameterValues,omitempty"`
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1.PipelineJob.RuntimeConfig.input_artifacts
	InputArtifacts map[string]PipelineJob_RuntimeConfig_InputArtifact `json:"inputArtifacts,omitempty"`
}
...
type PipelineTaskDetailObservedState struct {
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1.PipelineTaskDetail.inputs
	Inputs map[string]PipelineTaskDetail_ArtifactList `json:"inputs,omitempty"`

	// Output only. The runtime output artifacts of the task.
	// +kcc:proto:field=google.cloud.aiplatform.v1.PipelineTaskDetail.outputs
	Outputs map[string]PipelineTaskDetail_ArtifactList `json:"outputs,omitempty"`

...
func (in *WorkstationConfigSpec) DeepCopyInto(out *WorkstationConfigSpec) {
	*out = *in
	...
	if in.WorkstationClusterRef != nil {
		in, out := &in.WorkstationClusterRef, &out.WorkstationClusterRef
		*out = new(WorkstationClusterRef)
		**out = **in
	}
	if in.ResourceID != nil {
...
func (in *WorkstationSpec) DeepCopyInto(out *WorkstationSpec) {
	*out = *in
	...
	if in.WorkstationConfigRef != nil {
		in, out := &in.WorkstationConfigRef, &out.WorkstationConfigRef
		*out = new(WorkstationConfigRef)
		**out = **in
	}
	if in.ResourceID != nil {

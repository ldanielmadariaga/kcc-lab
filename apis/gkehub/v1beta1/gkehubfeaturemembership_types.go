...
type GKEHubFeatureMembershipStatus struct {
	...
	ObservedState *GKEHubFeatureMembershipObservedState `json:"observedState,omitempty"`
}
...
// GKEHubFeatureMembership is the Schema for the GKEHubFeatureMembership API

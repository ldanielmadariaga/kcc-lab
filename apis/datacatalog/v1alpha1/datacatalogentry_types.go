...
type DataCatalogEntrySpec struct {
	...
	// +kcc:guess=parent-location pattern=projects/{project}/locations/{location}/entryGroups/{entry_group}/entries/{entry}
	Location *string `json:"location,omitempty"`

	// The EntryGroup that this resource belongs to.
	// +kcc:guess=parent-ref target=EntryGroupRef pattern=projects/{project}/locations/{location}/entryGroups/{entry_group}/entries/{entry}

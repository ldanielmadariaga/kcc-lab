...
/* unreachable type BackupRun
// +kcc:proto=google.cloud.sql.v1.BackupRun
...
type DiskEncryptionConfiguration struct {
	...
	// +kcc:proto:field=google.cloud.sql.v1.DiskEncryptionConfiguration.kms_key_name
...
/* unreachable type BackupRunObservedState
// +kcc:observedstate:proto=google.cloud.sql.v1.BackupRun
type BackupRunObservedState struct {

...
type VMwareEngineExternalAccessRuleSpec struct {
	...
	// +kcc:guess=parent-location pattern=projects/{project}/locations/{location}/networkPolicies/{network_policy}/externalAccessRules/{external_access_rule}
	Location *string `json:"location,omitempty"`

	// The NetworkPolicy that this resource belongs to.
	// +kcc:guess=parent-ref target=NetworkPolicyRef pattern=projects/{project}/locations/{location}/networkPolicies/{network_policy}/externalAccessRules/{external_access_rule}
	NetworkPolicyRef *NetworkPolicyRef `json:"networkPolicyRef,omitempty"`

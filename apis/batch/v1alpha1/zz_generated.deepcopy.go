...
func (in *UsageResourceAllowanceStatus_ConsumptionReportObservedState) DeepCopyInto(out *UsageResourceAllowanceStatus_ConsumptionReportObservedState) {
	*out = *in
	if in.LatestPeriodConsumptions != nil {
		...
		*out = make(map[string]UsageResourceAllowanceStatus_PeriodConsumption, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UsageResourceAllowanceStatus_PeriodConsumption) DeepCopyInto(out *UsageResourceAllowanceStatus_PeriodConsumption) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UsageResourceAllowanceStatus_PeriodConsumption.
func (in *UsageResourceAllowanceStatus_PeriodConsumption) DeepCopy() *UsageResourceAllowanceStatus_PeriodConsumption {
	if in == nil {
		return nil
	}
	out := new(UsageResourceAllowanceStatus_PeriodConsumption)
	in.DeepCopyInto(out)
	return out
}

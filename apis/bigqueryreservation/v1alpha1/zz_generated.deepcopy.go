...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BigQueryReservationCapacityCommitmentObservedState) DeepCopyInto(out *BigQueryReservationCapacityCommitmentObservedState) {
	*out = *in
	if in.State != nil {
	...
	if in.FailureStatus != nil {
		in, out := &in.FailureStatus, &out.FailureStatus
		*out = new(common.Status)
		(*in).DeepCopyInto(*out)
	}
	if in.IsFlatRate != nil {
		in, out := &in.IsFlatRate, &out.IsFlatRate
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BigQueryReservationCapacityCommitmentObservedState.
func (in *BigQueryReservationCapacityCommitmentObservedState) DeepCopy() *BigQueryReservationCapacityCommitmentObservedState {
	if in == nil {
		return nil
	}
	out := new(BigQueryReservationCapacityCommitmentObservedState)
	in.DeepCopyInto(out)
	return out
}
